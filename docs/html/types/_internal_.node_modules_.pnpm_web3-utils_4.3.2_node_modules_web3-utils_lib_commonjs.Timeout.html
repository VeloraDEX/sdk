...
<li><a href="" aria-current="page">Timeout</a></li></ul>
<h1>Type Alias Timeout</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">Timeout</span><span class="tsd-signature-symbol">:</span> <a href="_internal_.ReturnType.html" class="tsd-signature-type tsd-kind-type-alias">ReturnType</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-keyword">typeof</span> <span class="tsd-signature-type">setTimeout</span><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/.pnpm/web3-utils@4.3.2/node_modules/web3-utils/lib/commonjs/promise_helpers.d.ts:2</li></ul></aside></div>
