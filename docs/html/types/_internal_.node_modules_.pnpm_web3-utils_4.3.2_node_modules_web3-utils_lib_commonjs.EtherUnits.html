...
<li><a href="" aria-current="page">EtherUnits</a></li></ul>
<h1>Type Alias EtherUnits</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">EtherUnits</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-keyword">keyof</span> <span class="tsd-signature-keyword">typeof</span> <a href="../variables/_internal_.node_modules_.pnpm_web3-utils_4.3.2_node_modules_web3-utils_lib_commonjs.ethUnitMap.html" class="tsd-signature-type tsd-kind-variable">ethUnitMap</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/.pnpm/web3-utils@4.3.2/node_modules/web3-utils/lib/commonjs/converters.d.ts:33</li></ul></aside></div>
