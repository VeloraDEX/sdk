...
<li><a href="" aria-current="page">AbiItem</a></li></ul>
<h1>Type Alias AbiItem</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">AbiItem</span><span class="tsd-signature-symbol">:</span> <a href="_internal_.AbiFragment.html" class="tsd-signature-type tsd-kind-type-alias">AbiFragment</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/.pnpm/web3-types@1.8.1/node_modules/web3-types/lib/commonjs/eth_abi_types.d.ts:87</li></ul></aside></div>
