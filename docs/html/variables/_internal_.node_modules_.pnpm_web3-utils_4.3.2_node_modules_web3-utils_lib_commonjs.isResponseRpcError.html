...
<li><a href="" aria-current="page">isResponseRpcError</a></li></ul>
<h1>Variable isResponseRpcError<code class="tsd-tag">Const</code></h1></div>
<div class="tsd-signature"><span class="tsd-kind-variable">isResponseRpcError</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">rpcError</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/_internal_.JsonRpcResponseWithError.html" class="tsd-signature-type tsd-kind-interface">JsonRpcResponseWithError</a><span class="tsd-signature-symbol">)</span> <span class="tsd-signature-symbol">=&gt;</span> <span class="tsd-signature-type">boolean</span></div>
<div class="tsd-type-declaration">
<h4>Type Declaration</h4>
<ul class="tsd-parameters">
<li class="tsd-parameter-signature">
<ul class="tsd-signatures tsd-is-external">
<li class="tsd-signature" id="__type"><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">rpcError</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/_internal_.JsonRpcResponseWithError.html" class="tsd-signature-type tsd-kind-interface">JsonRpcResponseWithError</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">boolean</span></li>
<li class="tsd-description">
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li><span><span class="tsd-kind-parameter">rpcError</span>: <a href="../interfaces/_internal_.JsonRpcResponseWithError.html" class="tsd-signature-type tsd-kind-interface">JsonRpcResponseWithError</a></span></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4></li></ul></li></ul></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/.pnpm/web3-utils@4.3.2/node_modules/web3-utils/lib/commonjs/json_rpc.d.ts:2</li></ul></aside></div>
