...
<li><a href="" aria-current="page">utf8ToBytes</a></li></ul>
<h1>Variable utf8ToBytes<code class="tsd-tag">Const</code></h1></div>
<div class="tsd-signature"><span class="tsd-kind-variable">utf8ToBytes</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-keyword">typeof</span> <a href="../functions/_internal_.utf8ToBytes.html" class="tsd-signature-type tsd-kind-function">utf8ToBytes</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/.pnpm/web3-utils@4.3.2/node_modules/web3-utils/lib/commonjs/converters.d.ts:153</li></ul></aside></div>
