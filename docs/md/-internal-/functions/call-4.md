...
Defined in: node\_modules/.pnpm/viem@2.56.1\_typescript@5.9.3\_zod@3.25.76/node\_modules/viem/\_types/actions/token/transfer.d.ts:86
...
[`Args`](../type-aliases/Args-4.md)\<`chain`, `tokens`\>
