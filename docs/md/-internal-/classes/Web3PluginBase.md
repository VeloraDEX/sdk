...
[@velora-dex/sdk](../../globals.md) / [\<internal\>](../README.md) / Web3PluginBase

# Class: `abstract` Web3PluginBase\<API\>

Extend this class when creating a plugin that either doesn't require [EthExecutionAPI](../type-aliases/EthExecutionAPI.md),
or interacts with a RPC node that doesn't fully implement [EthExecutionAPI](../type-aliases/EthExecutionAPI.md).

To add type support for RPC methods to the [Web3RequestManager](Web3RequestManager.md),
define a [Web3APISpec](../type-aliases/Web3APISpec.md) and pass it as a generic to Web3PluginBase like so:
...
- [`Web3Context`](Web3Context.md)\<`API`\>
...
> **new Web3PluginBase**\<`API`\>(`providerOrContext`?): [`Web3PluginBase`](Web3PluginBase.md)\<`API`\>

#### Parameters

• **providerOrContext?**: `string` \| [`SupportedProviders`](../type-aliases/SupportedProviders.md)\<`API`\> \| [`Web3ContextInitOptions`](../type-aliases/Web3ContextInitOptions.md)\<`API`, `any`\>

#### Returns

[`Web3PluginBase`](Web3PluginBase.md)\<`API`\>
...
> `protected` **\_subscriptionManager**: [`Web3SubscriptionManager`](Web3SubscriptionManager.md)\<`API`, `any`\>
...
node\_modules/.pnpm/web3-core@4.7.0/node\_modules/web3-core/lib/commonjs/web3\_context.d.ts:185
...
> **getContextObject**(): [`Web3ContextObject`](../type-aliases/Web3ContextObject.md)\<`API`, `any`\>

#### Returns

[`Web3ContextObject`](../type-aliases/Web3ContextObject.md)\<`API`, `any`\>
...
> `protected` **registerNewTransactionType**\<`NewTxTypeClass`\>(`type`, `txClass`): `void`

#### Type Parameters

• **NewTxTypeClass** *extends* *typeof* [`BaseTransaction`](BaseTransaction.md)
...
node\_modules/.pnpm/web3-core@4.7.0/node\_modules/web3-core/lib/commonjs/web3\_context.d.ts:186
