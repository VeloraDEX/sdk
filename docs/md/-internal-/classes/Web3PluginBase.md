...
# Abstract Class: Web3PluginBase\<API\>

Defined in: node\_modules/.pnpm/web3-core@4.7.0/node\_modules/web3-core/lib/commonjs/web3\_context.d.ts:184
...
> **new Web3PluginBase**\<`API`\>(`providerOrContext?`): `Web3PluginBase`\<`API`\>
...
`string` \| [`SupportedProviders`](../type-aliases/SupportedProviders.md)\<`API`\> \| [`Web3ContextInitOptions`](../type-aliases/Web3ContextInitOptions.md)\<`API`, `any`\>
...
Defined in: node\_modules/.pnpm/web3-core@4.7.0/node\_modules/web3-core/lib/commonjs/web3\_context.d.ts:185
...
Defined in: node\_modules/.pnpm/web3-core@4.7.0/node\_modules/web3-core/lib/commonjs/web3\_context.d.ts:186
