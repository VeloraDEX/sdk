...
> `readonly` **options**: [`ContractOptions`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/ContractOptions.md)
...
> **get** **events**(): [`ContractEventsInterface`](../type-aliases/ContractEventsInterface.md)\<`Abi`, [`ContractEvents`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/type-aliases/ContractEvents.md)\<`Abi`\>\>
...
[`ContractEventsInterface`](../type-aliases/ContractEventsInterface.md)\<`Abi`, [`ContractEvents`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/type-aliases/ContractEvents.md)\<`Abi`\>\>
...
• **Options** *extends* [`PayableCallOptions`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/PayableCallOptions.md) \| [`NonPayableCallOptions`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/NonPayableCallOptions.md)
...
• **\_\_namedParameters.abi**: [`AbiFunctionFragment`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/type-aliases/AbiFunctionFragment.md)

• **\_\_namedParameters.contractOptions?**: [`ContractOptions`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/ContractOptions.md)
...
> **decodeMethodData**(`data`): [`DecodedParams`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/DecodedParams.md) & `object`
...
[`DecodedParams`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/DecodedParams.md) & `object`
...
• **deployOptions.arguments?**: [`ContractConstructorArgs`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/type-aliases/ContractConstructorArgs.md)\<`Abi`\>
...
> **getPastEvents**\<`ReturnFormat`\>(`returnFormat`?): `Promise`\<(`string` \| [`EventLog`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/EventLog.md))[]\>
...
`Promise`\<(`string` \| [`EventLog`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/EventLog.md))[]\>
...
> **getPastEvents**\<`ReturnFormat`\>(`eventName`, `returnFormat`?): `Promise`\<(`string` \| [`EventLog`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/EventLog.md))[]\>
...
• **eventName**: `"allEvents"` \| keyof [`ContractEvents`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/type-aliases/ContractEvents.md)\<`Abi`\> \| `"ALLEVENTS"`
...
> **getPastEvents**\<`ReturnFormat`\>(`filter`, `returnFormat`?): `Promise`\<(`string` \| [`EventLog`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/EventLog.md))[]\>
...
> **getPastEvents**\<`ReturnFormat`\>(`eventName`, `filter`, `returnFormat`?): `Promise`\<(`string` \| [`EventLog`](../namespaces/Users_andriishymkiv_paraswap_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/EventLog.md))[]\>
