...
node\_modules/.pnpm/@types+node@22.7.5/node\_modules/@types/node/stream.d.ts:1077
...
[`WritableBase`](WritableBase.md).[`[captureRejectionSymbol]`](WritableBase.md#%5Bcapturerejectionsymbol%5D-1)

#### Inherited from

[`ReadableBase`](ReadableBase.md).[`[captureRejectionSymbol]`](ReadableBase.md#%5Bcapturerejectionsymbol%5D-1)
...
`ReadableBase.[captureRejectionSymbol]`
