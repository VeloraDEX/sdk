...
> `protected` **formatSubscriptionResult**(`data`): [`BlockHeaderOutput`](../namespaces/Users_andriishymkiv_work_velora_sdk_node_modules_web3-types_lib_commonjs_index/interfaces/BlockHeaderOutput.md)

#### Parameters

• **data**: [`BlockHeaderOutput`](../namespaces/Users_andriishymkiv_work_velora_sdk_node_modules_web3-types_lib_commonjs_index/interfaces/BlockHeaderOutput.md)

#### Returns

[`BlockHeaderOutput`](../namespaces/Users_andriishymkiv_work_velora_sdk_node_modules_web3-types_lib_commonjs_index/interfaces/BlockHeaderOutput.md)
